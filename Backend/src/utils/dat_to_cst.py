from src.lib.airfoil_generation import class_shape_transformation
import numpy as np
import math as mh
import os

from src.utils._evaluate_error import measure_closeness


def CST_fitting(input_path, output_path, Bernstein_order):
    """
    args:
